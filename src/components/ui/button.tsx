    ...
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold cursor-pointer transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        premium:
          "bg-primary text-primary-foreground shadow-[var(--shadow-glow)] hover:bg-primary-bright hover:-translate-y-0.5",
        luminous:
          "border border-foreground/20 bg-foreground/5 text-foreground backdrop-blur-md hover:bg-foreground/10",
